...
/** Stable reference — tránh remount BatchActionBar mỗi render (kill pipeline gen). */
function ElementBatchActionBar(props: { scenes: CopyVideoScene[] }) {
  return <BatchActionBar {...props} componentTab />;
}
        ...
        const updatedHistory = history.map((item: any) =>
          ...
          item.id === selectedHistoryId
            ...
            ? {
                ...
                data: mergeSceneListIntoData(item.data, sceneListKey, updatedScenes),
  ...
  return (
    ...
    <>
      ...
      <SharedBatchListPanel
        ...
        ActionBarComponent={ElementBatchActionBar}
