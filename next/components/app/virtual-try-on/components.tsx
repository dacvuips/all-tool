      ...
      >
        ...
        {hasCredential && !editMode ? (
          ...
          <div style={{ marginTop: 10 }}>
            ...
            >
              <span style={{ flex: 1, color: "#94a3b8", fontSize: 14, letterSpacing: 3 }}>
                ••••••••••••••••
              </span>
              <span
                style={{
                  ...
                  border: `1px solid ${
                    credentialActive ? "rgba(16,185,129,0.4)" : "rgba(239,68,68,0.4)"
                  }`,
                }}
              >
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: 10,
                  border: "none",
                  background: saving ? "rgba(139,92,246,0.4)" : CSS.gradAccent,
                  color: "#fff",
                  fontWeight: 700,
                  fontSize: 14,
                  cursor: saving ? "not-allowed" : "pointer",
                  opacity: !keyVal.trim() ? 0.5 : 1,
                }}
              >
        ...
        <p style={{ color: CSS.textMuted, fontSize: 11, marginTop: 6 }}>
          Chọn model hỗ trợ tạo ảnh (image generation)
        </p>
...
export function ImageUploader({
  ...
  onChange,
  onZoom,
  placeholder = "Kéo thả hoặc nhấp để tải ảnh",
  height = 160,
}: ImageUploaderProps) {
    ...
    <div>
      ...
      {urlMode ? (
        <div style={{ display: "flex", gap: 6 }}>
          ...
          />
          <button
            onClick={() => urlVal.trim() && onChange(urlVal.trim())}
            style={{
              padding: "8px 14px",
              borderRadius: CSS.radiusSm,
              border: "none",
        ...
        <div
          ...
          style={{
            ...
            border: `2px dashed ${dragging ? CSS.accent : "rgba(255,255,255,0.15)"}`,
