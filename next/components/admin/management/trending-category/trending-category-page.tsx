...
import { TrendingCategoryFields } from "./components/trending-category-fields";
  ...
  return (
    <Card>
      <DataTable<TrendingCategory>
        crudService={TrendingCategoryService}
            ...
            <>
              <DataTable.Table className="mt-4">
                    ...
                    <DataTable.CellText
                      ...
                      value={
                        <Switch
                          ...
                          onChange={async () => {
                            try {
                              const res = await TrendingCategoryService.update({
                                id: item.id,
                ...
                <DataTable.Column
                  ...
                  label={t("Số trending")}
                  render={(item: TrendingCategory) => (
                    <DataTable.CellNumber value={item.trendingIds?.length || 0} />
                  )}
                />
                <DataTable.Column
                  label={t("Ngày tạo")}
