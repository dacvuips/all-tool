...
const AlertContext = createContext<
  Partial<{
    info: (title: string, content?: string, confirm?: string) => Promise<boolean>;
    success: (title: string, content?: string, confirm?: string) => Promise<boolean>;
    error: (title: string, content?: string, confirm?: string) => Promise<boolean>;
    warn: (
      title: string,
      content?: string,
      confirm?: string,
...
export function AlertProvider({ children }: any) {
  ...
  const [type, setType] = useState<"success" | "error" | "info" | "warn" | "question">();
