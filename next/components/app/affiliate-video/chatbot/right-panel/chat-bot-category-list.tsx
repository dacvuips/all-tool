    ...
    <div className="flex flex-col h-full bg-[#0f1923]">
      ...
      <div className="overflow-y-auto flex-1 p-2 space-y-4 v-scrollbar xs:p-3">
        ...
        <NotifyText
          color="green"
          text={t(
            "Bạn hoàn toàn có thể kiếm thêm thu nhập từ chatbot bạn đưa lên bạn nhé! Kiếm tiền cùng tôi ngay bây giờ!, hãy tạo mới và công khai chatbot của bạn để kiếm thêm thu nhập!"
          )}
        />
