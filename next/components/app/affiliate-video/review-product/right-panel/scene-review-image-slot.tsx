...
export function SceneReviewImageSlot({
  slotIndex,
  value,
  readOnly = false,
  onChange,
  ...
  const previewSrc = useMemo(() => {
    ...
    return getReviewFormImagePreviewSrc(value);
  }, [value]);
  ...
  const processFile = useCallback(
    async (file: File) => {
      ...
      try {
        ...
        console.error("[SceneReviewImageSlot] Error processing file:", err);
