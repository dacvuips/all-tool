...
export function ChatMessageBoxAdmin({
  id,
  className = "",
  height,
  hasActionButton,
  ...
  return (
    <div className="flex relative flex-col items-center" ref={ref}>
      ...
      {scrollingMode && (
        <Button
          ...
          hoverWhite
          className="absolute bottom-3 text-gray-50 rounded-full shadow z-100 animate-emerge-up"
          icon={<FaArrowDown />}
          onClick={() => {
            scrollToBottom(true);
          }}
