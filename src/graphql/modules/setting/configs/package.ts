...
export default {
  ...
  settings: [
    ...
    {
      key: `pk-${SubscriptionPlanEnum.ENTERPRISE}-text-credit`,
      name: t("Unlimited - Giới hạn điểm Voice (-1 = không giới hạn)"),
      type: Type.number,
      isPrivate: false,
      isSecret: false,
      isActive: true,
    ...
    {
      key: `pk-${SubscriptionPlanEnum.PROFESSIONAL}-text-credit`,
      name: t("Professional - Giới hạn điểm Voice"),
      type: Type.number,
      isPrivate: false,
      isSecret: false,
      isActive: true,
    ...
    {
      key: `pk-${SubscriptionPlanEnum.STANDARD}-text-credit`,
      name: t("Standard - Giới hạn điểm Voice"),
      type: Type.number,
      isPrivate: false,
      isSecret: false,
      isActive: true,
    ...
    {
      key: `pk-${SubscriptionPlanEnum.BASIC}-text-credit`,
      name: t("Basic - Giới hạn điểm Voice"),
      type: Type.number,
      isPrivate: false,
      isSecret: false,
      isActive: true,
    ...
    {
      key: `pk-${SubscriptionPlanEnum.TRIAL}-text-credit`,
      name: t("Trial - Giới hạn điểm Voice"),
      type: Type.number,
      isPrivate: false,
      isSecret: false,
      isActive: true,
    ...
    {
      key: `pk-${SubscriptionPlanEnum.FREE}-text-credit`,
      name: t("Free - Giới hạn điểm Voice"),
      type: Type.number,
      isPrivate: false,
      isSecret: false,
      isActive: true,
