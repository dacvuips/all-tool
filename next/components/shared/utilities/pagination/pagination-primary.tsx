...
export function PaginationPrimary(props: PropsType) {
  ...
  const defaultButtonClass =
    `border-2 border-gray-400  text-gray-500 disabled:opacity-40 disabled:pointer-events-none ` +
  ...
  return (
    <PaginationComponent
      ...
      pageActiveButtonClass={`${defaultButtonClass
        ...
        .replace(" hover:text-primary", "")} bg-primary border-primary text-white hover:text-white`}
      prevButtonContent={
