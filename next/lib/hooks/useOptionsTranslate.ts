...
export const useOptionsTranslation = () => {
  ...
  const CATEGORY_OPTIONS = [
    { value: "ai", label: `🤖 ${t("AI")}` },
    { value: "am_nhac", label: `🎵 ${t("Âm Nhạc")}` },
    { value: "an_toan", label: `🦺 ${t("An Toàn")}` },
    { value: "bao_hiem", label: `🛡️ ${t("Bảo Hiểm")}` },
    { value: "bao_mat", label: `🔒 ${t("Bảo Mật")}` },
    { value: "bao_quan_thuc_pham", label: `🥬 ${t("Bảo Quản Thực Phẩm")}` },
    { value: "ban_hang_online", label: `🛒 ${t("Bán Hàng Online")}` },
    { value: "bbq", label: `🔥 ${t("BBQ")}` },
    { value: "ca_phe", label: `☕ ${t("Cà Phê")}` },
    { value: "cam_trai", label: `🏕️ ${t("Cắm Trại")}` },
    { value: "cham_thu_cung", label: `🐶 ${t("Chăm Thú Cưng")}` },
    { value: "chatgpt", label: `🤖 ${t("ChatGPT")}` },
    { value: "chinh_anh", label: `🖼️ ${t("Chỉnh Ảnh")}` },
    { value: "choi_game", label: `🎮 ${t("Chơi Game")}` },
    { value: "chup_anh", label: `📷 ${t("Chụp Ảnh")}` },
    { value: "cong_nghe", label: `💻 ${t("Công Nghệ")}` },
    { value: "crypto", label: `₿ ${t("Crypto")}` },
    { value: "dau_tu", label: `📈 ${t("Đầu Tư")}` },
    { value: "dien_thoai", label: `📱 ${t("Điện Thoại")}` },
    { value: "doc_sach", label: `📚 ${t("Đọc Sách")}` },
    { value: "do_an_chay", label: `🥗 ${t("Đồ Ăn Chay")}` },
    { value: "do_an_nhanh", label: `🍔 ${t("Đồ Ăn Nhanh")}` },
    { value: "do_uong", label: `🥤 ${t("Đồ Uống")}` },
    { value: "du_lich", label: `✈️ ${t("Du Lịch")}` },
    { value: "du_lich_tiet_kiem", label: `💸 ${t("Du Lịch Tiết Kiệm")}` },
    { value: "excel", label: `📊 ${t("Excel")}` },
    { value: "facebook", label: `📘 ${t("Facebook")}` },
    { value: "freelancer", label: `💼 ${t("Freelancer")}` },
    { value: "gia_dinh", label: `👨‍👩‍👧 ${t("Gia Đình")}` },
    { value: "giam_can", label: `⚖️ ${t("Giảm Cân")}` },
    { value: "giao_tiep", label: `🗣️ ${t("Giao Tiếp")}` },
    { value: "ghi_nho", label: `🧠 ${t("Ghi Nhớ")}` },
    { value: "gmail", label: `📧 ${t("Gmail")}` },
    { value: "hen_ho", label: `❤️ ${t("Hẹn Hò")}` },
    { value: "hoc_tap", label: `📖 ${t("Học Tập")}` },
    { value: "instagram", label: `📸 ${t("Instagram")}` },
    { value: "kinh_doanh", label: `📈 ${t("Kinh Doanh")}` },
    { value: "lam_banh", label: `🍰 ${t("Làm Bánh")}` },
    { value: "lam_dep", label: `💄 ${t("Làm Đẹp")}` },
    { value: "lam_viec", label: `💼 ${t("Làm Việc")}` },
    { value: "lam_vuon", label: `🌱 ${t("Làm Vườn")}` },
    { value: "lap_trinh", label: `👨‍💻 ${t("Lập Trình")}` },
    { value: "marketing", label: `📢 ${t("Marketing")}` },
    { value: "mang_xa_hoi", label: `📱 ${t("Mạng Xã Hội")}` },
    { value: "may_tinh", label: `🖥️ ${t("Máy Tính")}` },
    { value: "me_bau", label: `🤰 ${t("Mẹ Bầu")}` },
    { value: "meo_cuoc_song", label: `🏡 ${t("Mẹo Cuộc Sống")}` },
    { value: "meo_don_dep", label: `🧹 ${t("Mẹo Dọn Dẹp")}` },
    { value: "meo_nau_an", label: `🍳 ${t("Mẹo Nấu Ăn")}` },
    { value: "moi_truong", label: `🌍 ${t("Môi Trường")}` },
    { value: "ngoai_ngu", label: `🌎 ${t("Ngoại Ngữ")}` },
    { value: "ngu_ngon", label: `😴 ${t("Ngủ Ngon")}` },
    { value: "nguoi_cao_tuoi", label: `👴 ${t("Người Cao Tuổi")}` },
    { value: "nha_bep", label: `🍽️ ${t("Nhà Bếp")}` },
    { value: "nha_cua", label: `🏠 ${t("Nhà Cửa")}` },
    { value: "noi_an", label: `🎤 ${t("Nói Trước Đám Đông")}` },
    { value: "noi_that", label: `🛋️ ${t("Nội Thất")}` },
    { value: "nuoi_day_con", label: `👶 ${t("Nuôi Dạy Con")}` },
    { value: "nang_suat", label: `⚡ ${t("Năng Suất")}` },
    { value: "o_to", label: `🚗 ${t("Ô Tô")}` },
    { value: "phong_chong_lua_dao", label: `🚨 ${t("Phòng Chống Lừa Đảo")}` },
    { value: "phong_cach", label: `😎 ${t("Phong Cách")}` },
    { value: "phong_thuy", label: `🧿 ${t("Phong Thủy")}` },
    { value: "phong_van", label: `🤝 ${t("Phỏng Vấn")}` },
    { value: "powerpoint", label: `📽️ ${t("PowerPoint")}` },
    { value: "qua_tang", label: `🎁 ${t("Quà Tặng")}` },
    { value: "quan_ly_thoi_gian", label: `⏰ ${t("Quản Lý Thời Gian")}` },
    { value: "quay_video", label: `🎥 ${t("Quay Video")}` },
    { value: "san_sale", label: `🏷️ ${t("Săn Sale")}` },
    { value: "sang_tao", label: `💡 ${t("Sáng Tạo")}` },
    { value: "startup", label: `🚀 ${t("Startup")}` },
    { value: "sinh_ton", label: `🆘 ${t("Sinh Tồn")}` },
    { value: "sua_chua_nha", label: `🔨 ${t("Sửa Chữa Nhà")}` },
    { value: "suc_khoe", label: `❤️ ${t("Sức Khỏe")}` },
    { value: "tai_che", label: `♻️ ${t("Tái Chế")}` },
    { value: "tai_chinh", label: `💰 ${t("Tài Chính")}` },
    { value: "tam_ly", label: `🧠 ${t("Tâm Lý")}` },
    { value: "tang_can", label: `🥩 ${t("Tăng Cân")}` },
    { value: "the_duc", label: `🏋️ ${t("Thể Dục")}` },
    { value: "thoi_trang", label: `👗 ${t("Thời Trang")}` },
    { value: "thu_cong_diy", label: `🛠️ ${t("Thủ Công & DIY")}` },
    { value: "thuyet_trinh", label: `🖥️ ${t("Thuyết Trình")}` },
    { value: "tiec_tung", label: `🎉 ${t("Tiệc Tùng")}` },
    { value: "tiet_kiem_dien", label: `💡 ${t("Tiết Kiệm Điện")}` },
    { value: "tiet_kiem_nuoc", label: `🚰 ${t("Tiết Kiệm Nước")}` },
    { value: "to_chuc_nha", label: `📦 ${t("Tổ Chức Nhà Cửa")}` },
    { value: "tong_hop", label: `⭐ ${t("Tổng Hợp Mẹo Hay")}` },
    { value: "tra", label: `🍵 ${t("Trà")}` },
    { value: "trang_tri_nha", label: `🖼️ ${t("Trang Trí Nhà")}` },
    { value: "tre_so_sinh", label: `🍼 ${t("Trẻ Sơ Sinh")}` },
    { value: "trong_cay", label: `🪴 ${t("Trồng Cây")}` },
    { value: "tu_quan_ao", label: `👔 ${t("Tủ Quần Áo")}` },
    { value: "van_phong", label: `🏢 ${t("Văn Phòng")}` },
    { value: "van_phong_pham", label: `✏️ ${t("Văn Phòng Phẩm")}` },
    { value: "viet_cv", label: `📄 ${t("Viết CV")}` },
    { value: "viet_lach", label: `✍️ ${t("Viết Lách")}` },
    { value: "work_from_home", label: `🏡 ${t("Work From Home")}` },
    { value: "word", label: `📃 ${t("Word")}` },
    { value: "xe_may", label: `🏍️ ${t("Xe Máy")}` },
    { value: "youtube", label: `▶️ ${t("YouTube")}` },
    { value: "yoga", label: `🧘 ${t("Yoga")}` },
    { value: "zalo", label: `💬 ${t("Zalo")}` },
  ];
  ...
  const MOOD_OPTIONS = [
    { value: "adventurous", label: t("Phiêu lưu & Mạo hiểm") },
    { value: "aggressive", label: t("Mạnh mẽ & Quyết liệt") },
    { value: "analytical", label: t("Phân tích & Logic") },
    { value: "calm", label: t("Bình tĩnh & Nhẹ nhàng") },
    { value: "carefree", label: t("Vô tư & Thoải mái") },
    { value: "cheerful", label: t("Vui vẻ & Tích cực") },
    { value: "chill", label: t("Chill & Thư giãn") },
    { value: "cinematic", label: t("Điện ảnh & Hoành tráng") },
    { value: "classic", label: t("Cổ điển & Thanh lịch") },
    { value: "comedic", label: t("Hài hước & Duyên dáng") },
    { value: "confident", label: t("Tự tin & Bản lĩnh") },
    { value: "cool", label: t("Ngầu & Cá tính") },
    { value: "cozy", label: t("Ấm áp & Gần gũi") },
    { value: "cute", label: t("Đáng yêu & Dễ thương") },
    { value: "dark", label: t("U tối & Bí ẩn") },
    { value: "dreamy", label: t("Mơ màng & Bay bổng") },
    { value: "elegant", label: t("Thanh lịch & Tinh tế") },
    { value: "emotional", label: t("Cảm xúc & Chân thành") },
    { value: "energetic", label: t("Tràn đầy năng lượng") },
    { value: "epic", label: t("Hùng tráng & Sử thi") },
    { value: "excited", label: t("Hào hứng & Phấn khích") },
    { value: "friendly", label: t("Thân thiện & Cởi mở") },
    { value: "funny", label: t("Tấu hài & Lầy lội") },
    { value: "gentle", label: t("Dịu dàng & Nhẹ nhàng") },
    { value: "happy", label: t("Hạnh phúc & Lạc quan") },
    { value: "heroic", label: t("Anh hùng & Chính nghĩa") },
    { value: "honest", label: t("Thẳng thắn & Trung thực") },
    { value: "hopeful", label: t("Hy vọng & Lạc quan") },
    { value: "humble", label: t("Khiêm tốn & Chân thật") },
    { value: "inspiring", label: t("Truyền cảm hứng") },
    { value: "luxury", label: t("Sang trọng & Đẳng cấp") },
    { value: "magical", label: t("Phép thuật & Kỳ ảo") },
    { value: "mature", label: t("Trưởng thành & Chín chắn") },
    { value: "mischievous", label: t("Tinh nghịch & Lém lỉnh") },
    { value: "motivational", label: t("Tạo động lực") },
    { value: "mysterious", label: t("Bí ẩn & Cuốn hút") },
    { value: "nostalgic", label: t("Hoài niệm & Cổ xưa") },
    { value: "passionate", label: t("Đam mê & Nhiệt huyết") },
    { value: "playful", label: t("Tinh nghịch & Vui nhộn") },
    { value: "professional", label: t("Chuyên nghiệp & Chuẩn mực") },
    { value: "relaxing", label: t("Thư giãn & Êm dịu") },
    { value: "romantic", label: t("Lãng mạn & Ngọt ngào") },
    { value: "sarcastic", label: t("Mỉa mai & Châm biếm") },
    { value: "scary", label: t("Đáng sợ & Rùng rợn") },
    { value: "serious", label: t("Nghiêm túc & Chuyên sâu") },
    { value: "soft", label: t("Mềm mại & Nhẹ nhàng") },
    { value: "sporty", label: t("Thể thao & Máu lửa") },
    { value: "surprising", label: t("Bất ngờ & Gây sốc") },
    { value: "vintage", label: t("Vintage & Hoài cổ") },
    { value: "warm", label: t("Ấm áp & Chân thành") },
  ];
