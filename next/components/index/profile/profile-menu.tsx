...
export function ProfileMenu({ selectedMenu, ...props }) {
  ...
  return (
    <div className="w-1/4 h-full bg-white rounded-md">
      {customer && (
        <div className="flex flex-row items-center p-5 border-b">
          ...
          />
          <div className="w-full ml-4 overflow-ellipsis">
            <div className="">{t("Tài khoản của")}</div>
            <div className="font-semibold leading-6 capitalize text-ellipsis text-accent text-18 whitespace-nowrap">
        ...
        return (
          <Link href={item.href} key={index}>
            <div
              ...
              } flex flex-row items-center py-4 hover:bg-gray-50`}
            >
              <span className="mr-4 text-primary text-24 pl-7"> {item.icon}</span>
