...
export function SubMenu({ opened, activeSubmenu, item, ...props }: SubMenuProps) {
  ...
  return (
    <>
      <li className="items-center py-2 cursor-pointer " onClick={open}>
        <div className="flex items-center px-4 py-2 hover:text-primary-dark">
          <div className="w-5 h-5 mr-3 icon text-primary">{item.icon}</div>
