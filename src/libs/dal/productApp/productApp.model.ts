...
import { AiProviderKeyEnum, IProductApp, PropertyTypeEnum } from "./productApp.interface";
...
export const ProductModel = MainConnection.model<IProductApp>("Product", productAppSchema);
